...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'tanggal_request','class'=>'form-control'));?>
        ...
        <div class="form-group">
            ...
            <?php echo button('send_form(document.faddmenugrup,"transaksi/request_barang/show_addForm/","#divsubcontent")','Simpan','btn btn-warning')."";?>
            </div>
        </div>
    </form>
</div>
