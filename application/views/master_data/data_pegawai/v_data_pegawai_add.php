...
<div class="box-body big">
    <?php echo form_open('',array('name'=>'faddmenugrup','class'=>'form-horizontal','role'=>'form'));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'nama_pegawai','class'=>'form-control'));?>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
            <?php echo form_input(array('name'=>'jabatan','class'=>'form-control'));?>
        ...
        <div class="form-group">
            ...
            <?php echo button('send_form(document.faddmenugrup,"master_data/data_pegawai/show_addForm/","#divsubcontent")','Simpan','btn btn-warning')."";?>
            </div>
        </div>
    </form>
</div>
